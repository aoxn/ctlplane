...
func TestServer_Response_LargeWrite_FlowControlled(t *testing.T) {
    ...
    testServerResponse(t, func(w http.ResponseWriter, r *http.Request) error {
        ...
        getSlash(st) // make the single request
        defer func() {
            st.fr.WriteRSTStream(1, ErrCodeCancel)
        }()
...
func TestServer_Rejects_TLS10(t *testing.T) {
    testRejectTLS(t, tls.VersionTLS10)
}
func TestServer_Rejects_TLS11(t *testing.T) {
    testRejectTLS(t, tls.VersionTLS11)
}
...
func TestServerWithCurl(t *testing.T) {
    testServerWithCurl(t, false)
}
func TestServerWithCurl_LenientCipherSuites(t *testing.T) {
    testServerWithCurl(t, true)
}
...
func (c *issue53Conn) SetDeadline(t time.Time) error {
    return nil
}
func (c *issue53Conn) SetReadDeadline(t time.Time) error {
    return nil
}
func (c *issue53Conn) SetWriteDeadline(t time.Time) error {
    return nil
}
