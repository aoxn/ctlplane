...
(function () {
    Epoch.TestContext = function () {
        ...
        e.prototype.getImageData = function () {
            ...
            return {width: 0, height: 0, resolution: 1, data: []}
        };
        return e
    }()
}).call(this);
(function () {
    ...
    Epoch.Util.formatSI = function (c, a, d) {
        ...
        f = "KMGTPEZY".split("");
        for (h in f)if (k = f[h], b = Math.pow(10, 3 * ((h | 0) + 1)), c >= b && c < Math.pow(10,
                3 * ((h | 0) + 2))) {
            c /= b;
    ...
    Epoch.Util.formatBytes = function (c, a, d) {
        ...
        for (h in f)if (k = f[h], b = Math.pow(1024, (h | 0) + 1), c >= b && c < Math.pow(1024, (h | 0) + 2)) {
            c /= b;
            if (0 !== c % 1 || d)c = c.toFixed(a);
            return "" + c + " " + k
        }
    ...
    Epoch.Util.domain =
        function (c, a) {
            ...
            d = [];
            k = 0;
            for (q = c.length; k < q; k++)for (b = c[k], m = b.values, f = 0, u = m.length; f < u; f++)b = m[f], null == h[b[a]] && (d.push(b[a]), h[b[a]] = !0);
            return d
        };
    ...
    Epoch.Util.toRGBA = function (c, a) {
        var d, b,
            h;
        if (d = c.match(/^rgba\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*[0-9\.]+\)/))h = d[1], b = d[2], d = d[3], b = "rgba(" + h + "," + b + "," + d + "," + a + ")"; else if (d = d3.rgb(c))b = "rgba(" + d.r + "," + d.g + "," + d.b + "," + a + ")";
        return b
    };
...
(function () {
    var e = {}.hasOwnProperty, g = function (c, a) {
        function d() {
            this.constructor = c
        }
    ...
    Epoch.Chart.Base = function (c) {
        ...
        b = {"option:width": "dimensionsChanged", "option:height": "dimensionsChanged"};
    ...
    Epoch.Chart.SVG = function (c) {
        function a(d) {
            ...
            this.svg.attr({xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height})
        }
    ...
    Epoch.Chart.Canvas = function (c) {
        ...
        a.prototype.dimensionsChanged = function () {
            a.__super__.dimensionsChanged.call(this);
            this.canvas.style({width: "" + this.width + "px", height: "" + this.height + "px"});
            return this.canvas.attr({width: this.getWidth(), height: this.getHeight()})
        };
        return a
    }(Epoch.Chart.Base)
}).call(this);
...
(function () {
    ...
    Epoch.Chart.Plot = function (c) {
        ...
        d = {top: 25, right: 50, bottom: 25, left: 50};
        h = {
        ...
        a.prototype.axesChanged = function () {
            ...
            f = 0;
            for (b = c.length; f < b; f++)if (a = c[f], null == this.options.margins || null == this.options.margins[a])this.hasAxis(a) ?
...
(function () {
    ...
    Epoch.Chart.Area = function (c) {
        ...
        a.prototype.y = function () {
            ...
            q = this.data;
            k = 0;
            for (f = q.length; k < f; k++)for (b in c = q[k], u = c.values, u)c = u[b], null != a[b] && (a[b] += c.y), null == a[b] && (a[b] = c.y);
...
(function () {
    ...
    Epoch.Chart.Bar = function (c) {
        ...
        a.prototype._remapData = function () {
            ...
            t = this.data;
            h = 0;
            for (e = t.length; h < e; h++)for (d = t[h], a = "bar " + d.className.replace(/\s*layer\s*/, ""), v = d.values, n = 0, g = v.length; n < g; n++)f = v[n], null == c[s = f.x] && (c[s] = []),
                c[f.x].push({label: d.category, y: f.y, className: a});
            f = [];
            for (b in c)a = c[b], f.push({group: b, values: a});
            return f
        };
        a.prototype.draw = function () {
...
(function () {
    ...
    Epoch.Chart.Scatter = function (c) {
        ...
        var d;
        g(a, c);
        d = {radius: 3.5, axes: ["top", "bottom", "left", "right"]};
        a.prototype.draw = function () {
            var b, c, k, f,
                d;
            b = [this.x(), this.y()];
...
(function () {
    ...
    Epoch.Time.Plot = function (c) {
        ...
        a.prototype._sizeCanvas = function () {
            this.canvas.attr({width: this.innerWidth(), height: this.innerHeight()});
        ...
        a.prototype._resetInitialTimeTicks = function () {
            ...
            h = this.data;
            a = 0;
            for (b = h.length; a < b; a++)if (c = h[a], null != c.values && 0 < c.values.length) {
        ...
        a.prototype._updateTicks = function (a) {
            if (this.hasAxis("top") || this.hasAxis("bottom"))if (++this._tickTimer % this.options.ticks.time || this._pushTick(this.options.windowSize, a, !0), !(0 <= this._ticks[0].x - this.w() / this.pixelRatio))return this._ticks[0].exit = !0
        };
        ...
        a.prototype.axesChanged = function () {
            ...
            b = 0;
            for (c = h.length; b < c; b++)if (a = h[b], null == this.options.margins || null == this.options.margins[a])this.hasAxis(a) ? this.margins[a] = d[a] : this.margins[a] = 6;
            this._sizeCanvas();
            this._buildAxes();
            return this.draw(this.animation.frame * this.animation.delta())
        };
...
(function () {
    ...
    Epoch.Time.Bar = function (c) {
        ...
        a.prototype.draw = function (c) {
            ...
            t = this.data;
            r = 0;
            for (s = t.length; r < s; r++)if (m = t[r], 0 < m.values.length)for (this.setStyles(m.className), e = [this.options.windowSize, m.values.length, this.inTransition()], f = e[0], g = e[1], e = (l = e[2]) ? -1 : 0; --f >= e && 0 <= --g;)b = m.values[g], k = [f * n + c,
                b.y, b.y0], b = k[0], h = k[1], k = k[2], l && (b += n), b = [b + 1, p(h + k), n - 2, this.innerHeight() - p(h) + 0.5 * this.pixelRatio], this.ctx.fillRect.apply(this.ctx, b), this.ctx.strokeRect.apply(this.ctx, b);
            return a.__super__.draw.call(this)
        };
        return a
    }(Epoch.Time.Stack)
...
(function () {
    ...
    Epoch.Time.Gauge = function (c) {
        function a(c) {
            ...
            this.svg.style({position: "absolute", "z-index": "1"});
            ...
            this.animation = {interval: null, active: !1, delta: 0, target: 0};
        ...
        var d, b;
        g(a, c);
        d = {domain: [0, 1], ticks: 10, tickSize: 5, tickOffset: 5, fps: 34, format: Epoch.Formats.percent};
        b = {
            "option:domain": "domainChanged",
            "option:ticks": "ticksChanged",
...
(function () {
    ...
    Epoch.Time.Line = function (c) {
        ...
        a.prototype.draw = function (c) {
            ...
            p = this.data;
            l = 0;
            for (n = p.length; l < n; l++)if (f = p[l], 0 < f.values.length) {
